...
def make_env(game, level):
    ...
    #     {"game": "SonicTheHedgehog-Genesis", "state": "ScrapBrain.Act2"},
    #     {"game": "SonicTheHedgehog-Genesis", "state": "ScrapBrain.Act1"},
